...
public final class userGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<protobuf.LoginRequest,
      protobuf.Response> getLoginMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "login",
      requestType = protobuf.LoginRequest.class,
      responseType = protobuf.Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<protobuf.LoginRequest,
      protobuf.Response> getLoginMethod() {
    io.grpc.MethodDescriptor<protobuf.LoginRequest, protobuf.Response> getLoginMethod;
    if ((getLoginMethod = userGrpc.getLoginMethod) == null) {
      synchronized (userGrpc.class) {
        if ((getLoginMethod = userGrpc.getLoginMethod) == null) {
          userGrpc.getLoginMethod = getLoginMethod =
              io.grpc.MethodDescriptor.<protobuf.LoginRequest, protobuf.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "login"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  protobuf.LoginRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  protobuf.Response.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<protobuf.Logout,
      protobuf.Response> getLogoutMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "logout",
      requestType = protobuf.Logout.class,
      responseType = protobuf.Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<protobuf.Logout,
      protobuf.Response> getLogoutMethod() {
    io.grpc.MethodDescriptor<protobuf.Logout, protobuf.Response> getLogoutMethod;
    if ((getLogoutMethod = userGrpc.getLogoutMethod) == null) {
      synchronized (userGrpc.class) {
        if ((getLogoutMethod = userGrpc.getLogoutMethod) == null) {
          userGrpc.getLogoutMethod = getLogoutMethod =
              io.grpc.MethodDescriptor.<protobuf.Logout, protobuf.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "logout"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  protobuf.Logout.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  protobuf.Response.getDefaultInstance()))
  ...
  public static abstract class userImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void login(protobuf.LoginRequest request,
        io.grpc.stub.StreamObserver<protobuf.Response> responseObserver) {
      asyncUnimplementedUnaryCall(getLoginMethod(), responseObserver);
    }

    /**
     */
    public void logout(protobuf.Logout request,
        io.grpc.stub.StreamObserver<protobuf.Response> responseObserver) {
  ...
  public static final class userBlockingStub extends io.grpc.stub.AbstractBlockingStub<userBlockingStub> {
    ...
    /**
     */
    public protobuf.Response login(protobuf.LoginRequest request) {
    ...
    /**
     */
    public protobuf.Response logout(protobuf.Logout request) {
      return blockingUnaryCall(
  ...
  public static final class userFutureStub extends io.grpc.stub.AbstractFutureStub<userFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<protobuf.Response> login(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<protobuf.Response> logout(
        protobuf.Logout request) {
      return futureUnaryCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOGIN:
          serviceImpl.login((protobuf.LoginRequest) request,
              (io.grpc.stub.StreamObserver<protobuf.Response>) responseObserver);
          break;
        case METHODID_LOGOUT:
          serviceImpl.logout((protobuf.Logout) request,
              (io.grpc.stub.StreamObserver<protobuf.Response>) responseObserver);
          break;
        default:
  ...
  private static abstract class userBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return protobuf.User.getDescriptor();
    }
